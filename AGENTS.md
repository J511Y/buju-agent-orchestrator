...
3. 구현 + 최소 검증
  ...
  - README의 "현재 기본값" 표기(특히 `BUJU_BASE_DELAY_MS`, `BUJU_MAX_ACTIONS_PER_CYCLE`, `BUJU_STALL_429_COOLDOWN_TICKS`, `BUJU_COMBAT_STRATEGY_REFRESH_TICKS`)가 `config/strategy.env` 실값과 일치하는지 함께 확인
